...
export const Projects = () => {
    ...
    const projects = [
        {
            id: 1,
            image: "/SystemInfoApp.png",
            title: "System Info Dektop App",
            description: "A desktop application that fetches system and hardware information such as RAM, CPU, battery status, and more.",
            tags: ["Rust", "React", "Tauri", "Tailwind CSS"],
            demoUrl: "",
            githubUrl: "",
        },
        {
...

        {
            ...
            title: "My Portfolio",
            description: "A modern, responsive personal portfolio built with React and TailwindCSS to showcase my projects, skills, and experience.",
            tags: ["React", "Tailwind CSS", "Framer Motion"],
            demoUrl: "https://abdelouahab-portfolio.vercel.app/",
            githubUrl: "https://github.com/Abdelouahab-aourar/abdelouahab-portfolio.git",
        },
        {
            id: 4,
            image: "/Redvolt.png",
                ...
                {projects.map((project, key) => {
                    return (
                        <motion.div key={key} className="card-shadow rounded-xl card-hover bg-primary/5 z-30 backdrop-blur-lg overflow-hidden relative"
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ duration: 0.3, ease: [0.5, 0.6, 0.8, 1], delay: key * 0.15 }}
                            viewport={{ once: false, amount: 0.4 }}
                        >
                            <div className="h-48">
